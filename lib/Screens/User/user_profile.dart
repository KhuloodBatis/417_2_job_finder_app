...
class UserProfile extends StatelessWidget {
  static String id='UserProfileId';
                                ...
                                else
                                {
                                  try
                                  {
                                    await FirebaseFirestore.instance.collection('Users').doc(userModel.id).update(
                                      ...
                                      Provider.of<UserData>(context,listen: false).updateUserDate(phone: phoneController.text, name: nameController.text , address: addressController.text);
                                      instance.changeIsLoading(false);
